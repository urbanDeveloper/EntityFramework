<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="EntityFrameworkTPHCodeFirst.WebForm1" %>
    ...
    <form id="form1" runat="server">
     <div style="font-family:Arial">
        ...
        <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None">
         ...
         <br />
         <br />
         <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Add Contract Employee" Width="226px" />
         <br />
